...
# Compila o workspace: colcon build --symlink-install --packages-select ssc0712_t1
...
setup(
    ...
    description='SSC0712 Trabalho 1: exploração, detecção visual de bandeira (segmentação semântica) e captura com máquina de estados em ROS 2.',
    license='Apache-2.0',
